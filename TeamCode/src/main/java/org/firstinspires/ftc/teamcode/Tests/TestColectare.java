...
import com.qualcomm.robotcore.eventloop.opmode.LinearOpMode;    //Clasa din pachetul ce contine elemente specifice modurilor operationele ale SDK-ului
import com.qualcomm.robotcore.eventloop.opmode.TeleOp;          //Clasa ce ne ajuta sa facem distinctia intre cele doua grupari din aplicatia mobila TeleOP/Auto
import com.qualcomm.robotcore.hardware.DcMotor;                 //Clasa ce se ocupa de controlul motoarelor
import com.qualcomm.robotcore.hardware.DcMotorSimple;           //Clasa ce ne ajuta sa schimbam orientarea motorului

@TeleOp(name = "TestRecruti", group = "TeleOps")    //Se foloseste pentru o mai usoara indentificare a clasei in aplicatia mobila
...
public class TestColectare extends LinearOpMode {
    ...
    @Override //Ne ofera abilitatea de a suprascrie o metoda a superclass-ei astfel definind un comportament specific clasei subordonate (cea actuala)
